...
public class PreferenceConstants {
	...
	public static final String[][] FP_SERVER_TYPE_VALUES = { { "ldap", FP_SERVER_BASIC }, { "ldaps", FP_SERVER_SECURE } };
	...
	public static final String[][] FP_AUTHENTICATION_RADIO_VALUES = { { "None", FP_NONE }, { "Simple", FP_SIMPLE },
			{ "Strong", FP_STRONG } };
