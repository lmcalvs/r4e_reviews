...
/**
 * This is the item provider adapter for a {@link org.eclipse.mylyn.reviews.example.emftasks.Category} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CategoryItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Category_summary_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Category_summary_feature", "_UI_Category_type"),
				 EmfTasksPackage.Literals.CATEGORY__SUMMARY,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EmfTasksPackage.Literals.CATEGORY__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Category)object).getSummary();
