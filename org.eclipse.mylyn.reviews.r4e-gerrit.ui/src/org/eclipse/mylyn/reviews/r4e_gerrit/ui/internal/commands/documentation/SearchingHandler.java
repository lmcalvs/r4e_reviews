...
public class SearchingHandler extends AbstractHandler {
	...
	public Object execute(ExecutionEvent aEvent) throws ExecutionException {
		...
		R4EGerritPlugin.Ftracer.traceInfo("Search the documentation SearchingHandler  " ); //$NON-NLS-1$

		R4EGerritPlugin.Ftracer.traceInfo("Execute:  SearchingHandler() "  ); //$NON-NLS-1$
		try {
