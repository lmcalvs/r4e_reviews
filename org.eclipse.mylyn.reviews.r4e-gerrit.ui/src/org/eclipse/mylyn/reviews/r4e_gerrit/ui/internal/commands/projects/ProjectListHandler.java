...
public class ProjectListHandler extends AbstractHandler {
	...
	public Object execute(ExecutionEvent aEvent) throws ExecutionException {
		...
		R4EGerritPlugin.Ftracer.traceInfo("Search the Gerrit reviews for Projects List  " ); //$NON-NLS-1$

		R4EGerritPlugin.Ftracer.traceInfo("Execute:  ProjectList() "  ); //$NON-NLS-1$
		try {
