 ...
 * 
 * Description:
 * 	This class implements the implementation of the R4E-Gerrit UI Merged reviews handler.
 * 
 * Contributors:
...
public class AllMergedReviewsHandler extends AbstractHandler {
	...
	public Object execute(ExecutionEvent aEvent) throws ExecutionException {
		...
		R4EGerritPlugin.Ftracer.traceInfo("Search the Gerrit reviews for All Merged  " ); //$NON-NLS-1$
		try {
