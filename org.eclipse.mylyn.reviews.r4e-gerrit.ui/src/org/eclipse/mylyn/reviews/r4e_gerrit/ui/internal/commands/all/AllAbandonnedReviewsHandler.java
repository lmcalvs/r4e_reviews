 ...
 * 
 * Description:
 * 	This class implements the implementation of the R4E-Gerrit UI Abandoned reviews handler.
 * 
 * Contributors:
...
public class AllAbandonnedReviewsHandler extends AbstractHandler {
	...
	public Object execute(ExecutionEvent aEvent) throws ExecutionException {
		...
		R4EGerritPlugin.Ftracer.traceInfo("Search the Gerrit reviews for All Abandonned  " ); //$NON-NLS-1$
		try {
