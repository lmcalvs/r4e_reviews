 ...
 * 
 * Description:
 * 	This class implements the implementation of the R4E-Gerrit UI Access controls reviews handler.
 * 
 * Contributors:
...
public class AccessControlHandler extends AbstractHandler {
	...
	public Object execute(ExecutionEvent aEvent) throws ExecutionException {
		...
		R4EGerritPlugin.Ftracer.traceInfo("Search the documentation AccessControlHandler  " ); //$NON-NLS-1$

		R4EGerritPlugin.Ftracer.traceInfo("Execute:  AccessControlHandler() "  ); //$NON-NLS-1$
		try {
