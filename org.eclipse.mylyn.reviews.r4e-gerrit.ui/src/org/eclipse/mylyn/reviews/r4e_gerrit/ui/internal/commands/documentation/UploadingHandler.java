...
public class UploadingHandler extends AbstractHandler {
	...
	public Object execute(ExecutionEvent aEvent) throws ExecutionException {
		...
		R4EGerritPlugin.Ftracer.traceInfo("Search the documentation UploadingHandler  " ); //$NON-NLS-1$

		R4EGerritPlugin.Ftracer.traceInfo("Execute:  UploadingHandler() "  ); //$NON-NLS-1$
		try {
