...
public class CommentImpl extends ReviewComponentImpl implements Comment {
		...
		if (user != null && user.eIsProxy()) {
			...
			if (user != oldUser) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ModelPackage.COMMENT__USER, oldUser, user));
			}
		}
		return user;
	}
	...
	public void setType(CommentType newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.COMMENT__TYPE, oldType, type));
	}
