 ...
 */
public class ReviewsCompletedFilterHandler extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		if (!oldValue) {
			R4EUIPlugin.Ftracer.traceInfo("Apply Completed Reviews filter to ReviewNavigator");
			viewer.addFilter(filter);
		} else {
			R4EUIPlugin.Ftracer.traceInfo("Remove Completed Reviews filter from ReviewNavigator");
