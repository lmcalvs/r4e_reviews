 ...
 */
public class ReviewsCompletedFilterHandler extends AbstractHandler implements IElementUpdater {
	...
	/**
	 * Field COMMAND_MESSAGE. (value is ""Applying Hide Completed Reviews Filter..."")
	 */
	private static final String COMMAND_MESSAGE = "Applying Hide Completed Reviews Filter...";
	...
	public Object execute(final ExecutionEvent aEvent) {
		...
		final UIJob job = new UIJob(COMMAND_MESSAGE) {
			...
			public IStatus runInUIThread(IProgressMonitor monitor) {
				...
				final ReviewCompletedFilter filter = ((ReviewNavigatorActionGroup) R4EUIModelController.getNavigatorView()
						.getActionSet()).getReviewsCompletedFilter();
	...
	public void updateElement(UIElement element, Map parameters) {
		...
		Command command = commandService.getCommand(R4EUIConstants.REVIEWS_COMPLETED_FILTER_COMMAND);
