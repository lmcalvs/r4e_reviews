...
public class ReviewedElemsFilterHandler extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		if (!oldValue) {
			R4EUIPlugin.Ftracer.traceInfo("Apply hide reviewed elements filter to ReviewNavigator");
			viewer.addFilter(filter);
		} else {
			R4EUIPlugin.Ftracer.traceInfo("Remove hide reviewed elements filter from ReviewNavigator");
