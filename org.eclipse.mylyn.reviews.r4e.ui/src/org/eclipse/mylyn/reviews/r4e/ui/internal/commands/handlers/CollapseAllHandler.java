...
public class CollapseAllHandler extends AbstractHandler {
	...
	/**
	 * Field COMMAND_MESSAGE. (value is ""Collapsing All Elements..."")
	 */
	private static final String COMMAND_MESSAGE = "Collapsing All Elements...";
	...
	public Object execute(ExecutionEvent aEvent) {
		...
		final UIJob job = new UIJob(COMMAND_MESSAGE) {
			...
			public IStatus runInUIThread(IProgressMonitor monitor) {
				...
				R4EUIPlugin.Ftracer.traceInfo("Collapsing whole tree"); //$NON-NLS-1$
