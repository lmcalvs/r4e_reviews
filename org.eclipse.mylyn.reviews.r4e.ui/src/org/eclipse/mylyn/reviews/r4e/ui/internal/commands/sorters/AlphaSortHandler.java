...
public class AlphaSortHandler extends AbstractHandler {
	...
	/**
	 * Field COMMAND_MESSAGE. (value is ""Applying Alphabetical Sorter..."")
	 */
	private static final String COMMAND_MESSAGE = "Applying Alphabetical Sorter...";
		...
		final UIJob job = new UIJob(COMMAND_MESSAGE) {
			...
			public IStatus runInUIThread(IProgressMonitor monitor) {
				...
				if (null != oldSorter && oldSorter instanceof ReviewTypeComparator) {
					((ReviewNavigatorActionGroup) R4EUIModelController.getNavigatorView().getActionSet()).resetReviewTypeSorterCommand();
				}
