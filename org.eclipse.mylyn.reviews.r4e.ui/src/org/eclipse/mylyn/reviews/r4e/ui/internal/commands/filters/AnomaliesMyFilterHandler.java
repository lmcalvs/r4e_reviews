 ...
 */
public class AnomaliesMyFilterHandler extends AbstractHandler implements IElementUpdater {
	...
	/**
	 * Field COMMAND_MESSAGE. (value is ""Applying My Anomalies Filter..."")
	 */
	...
	public Object execute(final ExecutionEvent aEvent) {
		...
		final UIJob job = new UIJob(COMMAND_MESSAGE) {
			...
			public IStatus runInUIThread(IProgressMonitor monitor) {
				...
				final AnomaliesMyFilter filter = ((ReviewNavigatorActionGroup) R4EUIModelController.getNavigatorView()
						.getActionSet()).getCurrentReviewFilter();
	...
	public void updateElement(UIElement element, Map parameters) {
		...
		Command command = commandService.getCommand(R4EUIConstants.ANOMALIES_MY_FILTER_COMMAND);
