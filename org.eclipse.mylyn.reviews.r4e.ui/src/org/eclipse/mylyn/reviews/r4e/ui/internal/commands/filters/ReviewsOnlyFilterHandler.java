 ...
 */
public class ReviewsOnlyFilterHandler extends AbstractHandler implements IElementUpdater {
	...
	public void updateElement(UIElement element, Map parameters) {
		...
		Command command = commandService.getCommand(R4EUIConstants.REVIEWS_ONLY_FILTER_COMMAND);
