 ...
 */
public class AnomaliesOnlyFilterHandler extends AbstractHandler implements IElementUpdater {
	...
	/**
	 * Field COMMAND_MESSAGE. (value is ""Applying Anomalies Only Filter..."")
	 */
	private static final String COMMAND_MESSAGE = "Applying Anomalies Only Filter...";
	...
	public void updateElement(UIElement element, Map parameters) {
		...
		Command command = commandService.getCommand(R4EUIConstants.ANOMALIES_FILTER_COMMAND);
