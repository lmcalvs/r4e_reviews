...
public class ExpandAllHandler extends AbstractHandler {
	...
	/**
	 * Field COMMAND_MESSAGE. (value is ""Expanding All Elements..."")
	 */
	private static final String COMMAND_MESSAGE = "Expanding All Elements...";
	...
	public Object execute(ExecutionEvent aEvent) {
		...
		final UIJob job = new UIJob(COMMAND_MESSAGE) {
			...
			public IStatus runInUIThread(IProgressMonitor monitor) {
				...
				R4EUIPlugin.Ftracer.traceInfo("Expanding whole tree"); //$NON-NLS-1$
