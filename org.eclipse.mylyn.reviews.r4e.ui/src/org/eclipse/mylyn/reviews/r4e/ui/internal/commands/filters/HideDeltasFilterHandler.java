 ...
 */
public class HideDeltasFilterHandler extends AbstractHandler implements IElementUpdater {
	...
	/**
	 * Field COMMAND_MESSAGE. (value is ""Applying Hide Deltas Filter..."")
	 */
	private static final String COMMAND_MESSAGE = "Applying Hide Deltas Filter...";
	...
	public void updateElement(UIElement element, Map parameters) {
		...
		Command command = commandService.getCommand(R4EUIConstants.HIDE_DELTAS_FILTER_COMMAND);
