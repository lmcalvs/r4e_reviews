 ...
 */
public class ReviewsMyFilterHandler extends AbstractHandler implements IElementUpdater {
	...
	public void updateElement(UIElement element, Map parameters) {
		...
		Command command = commandService.getCommand(R4EUIConstants.REVIEWS_MY_FILTER_COMMAND);
