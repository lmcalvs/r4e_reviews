		...
		for (int i = 0; i < fOriginalItem.getChildren().length; i++) {
			if (((R4EUIFileContext) fOriginalItem.getChildren()[i]).getName().equals(TestUtils.JAVA_FILE1_PROJ_NAME)) {
				...
				Assert.assertEquals(TestUtils.JAVA_FILE1_PROJ_NAME, fOriginalItem.getItem()
						...
						.getTarget()
						.getName());
				Assert.assertEquals(623, ((R4ETextPosition) fOriginalItem.getItem()
						.getFileContextList()
						.get(i)
						.getDeltas()
						.get(0)
				...
				Assert.assertEquals(26, ((R4ETextPosition) fOriginalItem.getItem()
						.getFileContextList()
						.get(i)
						.getDeltas()
						.get(0)
				...
				Assert.assertEquals(687, ((R4ETextPosition) fOriginalItem.getItem()
						.getFileContextList()
						.get(i)
						.getDeltas()
						.get(1)
						.getTarget()
						.getLocation()).getStartPosition());
				Assert.assertEquals(65, ((R4ETextPosition) fOriginalItem.getItem()
						.getFileContextList()
						.get(i)
						.getDeltas()
						.get(1)
						.getTarget()
						.getLocation()).getLength());
				Assert.assertEquals(759, ((R4ETextPosition) fOriginalItem.getItem()
						.getFileContextList()
						.get(i)
						.getDeltas()
						.get(2)
		...
		for (int i = 0; i < fTargetItem.getChildren().length; i++) {
			if (((R4EUIFileContext) fTargetItem.getChildren()[i]).getName().equals(TestUtils.JAVA_FILE1_PROJ_NAME)) {
				...
				Assert.assertEquals(TestUtils.JAVA_FILE1_PROJ_NAME, fTargetItem.getItem()
						...
						.getTarget()
						.getName());
				Assert.assertEquals(623, ((R4ETextPosition) fTargetItem.getItem()
						.getFileContextList()
						.get(i)
						.getDeltas()
						.get(0)
						.getTarget()
						.getLocation()).getStartPosition());
				Assert.assertEquals(26, ((R4ETextPosition) fTargetItem.getItem()
						.getFileContextList()
						.get(i)
						.getDeltas()
						.get(0)
						.getTarget()
						.getLocation()).getLength());
				Assert.assertEquals(687, ((R4ETextPosition) fTargetItem.getItem()
						.getFileContextList()
						.get(i)
						.getDeltas()
						.get(1)
						.getTarget()
						.getLocation()).getStartPosition());
				Assert.assertEquals(65, ((R4ETextPosition) fTargetItem.getItem()
						.getFileContextList()
						.get(i)
						.getDeltas()
						.get(1)
						.getTarget()
						.getLocation()).getLength());
				Assert.assertEquals(759, ((R4ETextPosition) fTargetItem.getItem()
						.getFileContextList()
						.get(i)
						.getDeltas()
						.get(2)
