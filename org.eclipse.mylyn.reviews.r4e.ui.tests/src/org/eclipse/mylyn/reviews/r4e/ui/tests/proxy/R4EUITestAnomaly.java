...
public class R4EUITestAnomaly extends R4EUITestElement {
	...
	public R4EUIAnomalyBasic createLinkedAnomaly(R4EUIContent aContent, String aTitle, String aDescription,
		...
		IAnomalyInputDialog mockAnomalyDialog = mock(AnomalyInputDialog.class);
		R4EUIDialogFactory.getInstance().setAnomalyInputDialog(mockAnomalyDialog);
		...
		when(mockAnomalyDialog.getRuleReferenceValue()).thenReturn(aRule);
	...
	public R4EUIAnomalyBasic createExternalAnomaly(IResource aResource, String aTitle, String aDescription,
			R4EDesignRuleClass aClass, R4EDesignRuleRank aRank, Date aDueDate, R4EUIRule aRule) {
