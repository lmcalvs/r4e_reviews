...
public class R4EAnomalyTypeImpl extends CommentTypeImpl implements R4EAnomalyType {
	...
	protected EClass eStaticClass() {
		return RModelPackage.Literals.R4E_ANOMALY_TYPE;
	}
	...
	public void setType(String newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RModelPackage.R4E_ANOMALY_TYPE__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RModelPackage.R4E_ANOMALY_TYPE__TYPE:
				return getType();
		}
