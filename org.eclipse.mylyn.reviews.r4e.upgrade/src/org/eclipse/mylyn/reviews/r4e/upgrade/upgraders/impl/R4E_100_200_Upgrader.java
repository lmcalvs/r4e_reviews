 ...
 */
public class R4E_100_200_Upgrader extends R4EVersionUpgrader {
	...
	static Replacement[] REPLACEMENTS = new Replacement[] {
		...
		new Replacement("<location\\sxsi", "<locations xsi"), new Replacement(" fragmentVersion=\\S*\"", ""), 
		new Replacement("(<r4ecore:R4EReview.*\" )(name=\".*>)", "$1fragmentVersion=\"2\\.0\\.0\" $2") }; //$NON-NLS-1$ //$NON-NLS-2$
	
	/**
	 * Constructor
	 */
	public R4E_100_200_Upgrader() {
