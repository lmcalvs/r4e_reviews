...
public class TransResSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case TransResPackage.REVIEW_GROUP_RES: {
				...
				if (result == null) result = caseR4EReviewGroup(reviewGroupRes);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Review Group Res</em>'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Review Res</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
